...
// Este interface se genera a partir de la necesidad de definir el tipado
// de la petcion http realizada en el servicio, se puede realizar desde la web
// quicktype.io se obtiene un objeto Gif con todas sus propiedades.
// Es necesario para no dejar ningun objeto del tipo any
